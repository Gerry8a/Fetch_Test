...
import com.practicas.fetchtest.databinding.FragmentSecondGroupBinding
import com.practicas.fetchtest.model.RandomObject
import com.practicas.fetchtest.ui.adapters.ObjectAdapter
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class SecondGroup : Fragment() {


    private lateinit var binding: FragmentSecondGroupBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSecondGroupBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
